...
| `clean_export.py <work.dxf> <out.dxf> [--r2013]` | Re-host into a fresh ezdxf document for delivery: tables, blocks, dimensions (with their geometry blocks), all layouts; `audit()` must be 0/0; reports entity types the importer cannot carry |
...
`dwg2dxf`, `dwgread`, `dwglayers` built from the GNU LibreDWG 0.14 source (GPL-3) on Ubuntu 24.04 x64, static. SHA-256 `24801bc22c36730d6cd519da51424c65aa78cb95317cb4227429691371624252`.
